        ...
        <section className={style.bg}>
            ...
            <div className='w-[90%] m-auto bg-black bg-opacity-30 rounded-3xl border-4 border-double  z-10 relative my-20'>
                ...
                <div className='text-center text-white text-sm w-2/3 m-auto my-10'>
                    ...
                    <Link href={`${data?.location?.akad?.link}`} className="bg-slate-950 flex justify-center items-center border-white border rounded-lg w-3/4 m-auto p-2 my-10 " >
                        <GrLocationPin />
                        Open Location
                    </Link>
                </div>
            ...
            <div className='w-[90%] m-auto bg-black bg-opacity-30 rounded-3xl border-4 border-double  z-10 relative my-32'>
                ...
                <div className='text-center text-white text-sm w-2/3 m-auto my-10'>
                    ...
                    <Link href={`${data?.location?.resepsi?.link}`}className="bg-slate-950 flex justify-center items-center border-white border rounded-lg w-3/4 m-auto p-2 my-10 " >
                        <GrLocationPin />
                        Open Location
                    </Link>
                </div>
